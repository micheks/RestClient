...
import com.alliky.http.ssl.TrustAllCerts;
import com.alliky.http.ssl.TrustAllHostnameVerifier;
...
public class RestCreator {
    ...
    private static final class OKHttpHolder {
        ...
        private static final ArrayList<Interceptor> INTERCEPTORS = Config.getConfiguration(ConfigKeys.INTERCEPTOR);
    ...
    private static final class HttpServiceHolder {
        private static final IService HTTP_SERVICE =
                RetrofitHolder.RETROFIT_CLIENT.create(IService.class);
    }

    public static IService getHttpService() {
