...
public interface IService {
    ...
    @Multipart
    @POST
    Call<String> upload(@Url String url, @Part List<MultipartBody.Part> file, @HeaderMap WeakHashMap<String, String> headers);
    @POST
    Call<String> upload(@Url String url, @Body MultipartBody body, @HeaderMap WeakHashMap<String, String> headers);
